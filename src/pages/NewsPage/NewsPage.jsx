...
const NewsPage = () => {
  ...
  return (
    <div className="flex flex-col items-center p-4 bg-green-50">
      ...
      {news.length > 0 && (
        <div className="w-full max-w-5xl mb-8 cursor-pointer" onClick={() => setSelectedPost(news[0])}>
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700">
                {news[0].description.length > 100
                  ? news[0].description.substring(0, 100) + '...'
                  : news[0].description}
                {news[0].description.length > 100 && (
      ...
      <div className="grid grid-cols-[repeat(auto-fill,_240px)] gap-4 justify-start w-full max-w-5xl">
        {news.length > 1 ? (
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        {images && <img src={images} alt={title} className="w-full h-auto mb-4 rounded-lg" />}
