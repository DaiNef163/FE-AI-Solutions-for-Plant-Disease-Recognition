                    ...
                    <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                        <div className="sm:max-w-lg">
                            ...
                            <p className="mt-4 text-xl text-gray-500">
                                "Giải pháp AI cho nhận diện bệnh cây trồng đã đến! Hệ thống thông minh của chúng tôi sẽ
                                bảo vệ sức khỏe cây trồng của bạn trước những thách thức của tự nhiên."
                            </p>
                        </div>
                        <div>
                            <div className="mt-10">
